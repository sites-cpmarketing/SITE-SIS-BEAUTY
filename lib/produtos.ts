...
export const OFERTAS: Oferta[] = [
  ...
  },
  {
    id: "duo",
    nome: "Pague 2, Leve 3",
    subtitulo: "3 potes no preço de 2 — o 3º é por nossa conta",
    ...
    beneficios: [
      "3 potes — pague 2, o 3º é grátis",
      "Cada pote por apenas R$ 58",
      "Monte com goma, cápsula ou misture os dois",
      "90 dias de tratamento contínuo",
    ],
    freteGratis: true,
  },
  {
    id: "completo",
    nome: "Compre 5, Leve 6",
    subtitulo: "6 potes, 1 completamente grátis — o melhor custo-benefício",
    ...
    beneficios: [
      "Compre 5, leve 6 — 1 pote grátis",
      "Cada pote por apenas R$ 49",
      "Monte com goma, cápsula ou misture os dois",
      "6 meses de tratamento — resultado completo",
    ],
    freteGratis: true,
  },
];
